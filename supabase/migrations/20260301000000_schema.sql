...
alter table public.requests drop constraint valid_time_range;
alter table public.requests drop constraint accepted_by_valid;
...
add column hours_offered numeric;
